...
export const OgMegaHeader = () => {
  ...
  const { checkout, fetchAllCollections, collections } =
      ...
      <header className={header}>
        ...
        <div className={navHeader}>
          ...
          <h1 style={{ margin: 0, padding: 0 }}>
            <Link to="/">
              <img
                src="https://cdn.shopify.com/s/files/1/0582/1831/5820/files/logo_256x256.gif?v=1658329876"
                alt=""
              />
            </Link>
          </h1>
