...
const description =
  "配送ポリシーページ。シティサイクル · スポーツサイクル · CTB自転車 · 幼児用自転車 · 子供用自転車 · 三輪車 · 折りたたみ自転車 · きかんしゃトーマスなどの自転車製品を販売しています。";
  ...
  return (
    <>
      ...
      <div className="term_page">
        <h1>配送ポリシー</h1>
        <div className="description" dangerouslySetInnerHTML={{ __html: shopData.shop.shippingPolicy.body }} />
      </div>
    </>
  );
}
